...
public partial class Board
{
    ...
    private static int[] ReadExits(ReadOnlySpan<byte> exits)
    {
    ...
    private static Tile[] ReadTiles(ReadOnlySpan<RawTile> tiles)
    {
    ...
    private static int[] ReadParameters(ReadOnlySpan<byte> parameters)
    {
    ...
    public static void Write(Stream stream, int worldType, Board board)
    {
    ...
    private static byte[] WriteExits(ReadOnlySpan<int> exits)
    {
    ...
    private static RawTile[] WriteTiles(ReadOnlySpan<Tile> tiles)
    {
    ...
    private static byte[] WriteParameters(ReadOnlySpan<int> parameters)
    {
